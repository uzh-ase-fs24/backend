...
class TestLocationRiddleService(unittest.TestCase):
    ...
    def test_get_location_riddle(self):
        location_riddle = self.location_riddles_service.get_location_riddle("mock_location_riddle_id", "mock_user_id")
    ...
    def test_get_location_riddles_for_user(self):
        location_riddles = self.location_riddles_service.get_location_riddles_for_user("mock_user_id", "mock_requester_id")
    ...
    def test_guess_location_riddle(self):
        ...
        guess_result = self.location_riddles_service.guess_location_riddle("event", "mock_location_riddle_id",
                                                                           "mock_user2_id", [0.0, 0.0])
        self.assertEqual(guess_result["location_riddle"]["location_riddle_id"], "mock_location_riddle_id")
        self.assertEqual(guess_result["location_riddle"]["user_id"], "mock_user_id")
        self.assertEqual(guess_result["location_riddle"]["comments"], [])
        self.assertEqual(guess_result["location_riddle"]["guesses"],
    ...
    def test_rate_location_riddle(self):
        ...
        location_riddle = self.location_riddles_service.rate_location_riddle("mock_location_riddle_id",
                                                                             "mock_user2_id", 3)
        self.assertEqual(location_riddle.location_riddle_id, "mock_location_riddle_id")
        self.assertEqual(location_riddle.user_id, "mock_user_id")
        self.assertEqual(location_riddle.comments, [])
    ...
    def test_comment_location_riddle(self):
        location_riddle = self.location_riddles_service.comment_location_riddle("mock_location_riddle_id",
