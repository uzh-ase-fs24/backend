...
class TestCalculateScore(unittest.TestCase):
    def test_calculate_score_perfect_guess(self):
        ...
        score, _ = calculate_score_and_distance(
            actual_location, guessed_location, 10000, 100
        )
    ...
    def test_calculate_score_far_guess(self):
        ...
        score2, _ = calculate_score_and_distance(
            guessed_location, actual_location, 10000, 100
        )
