...
from src.helpers.CalculateScore import calculate_score
...
class TestCalculateScore(unittest.TestCase):
    def test_calculate_score_perfect_guess(self):
        ...
        score = calculate_score(actual_location, guessed_location, 10000, 100)
    ...
    def test_calculate_score_far_guess(self):
        ...
        score2 = calculate_score(guessed_location, actual_location, 10000, 100)
