...
class FollowRequest(BaseModel):
    requester_username: str = Field(description="The username of the user who sent the follow request")
    ...
    request_status: str = Field(description="The status of the follow request, e.g., 'pending', 'accepted', 'rejected'")
