...
class FollowerService:
    ...
    def create_follower_request(
        self, requester_username: str, requester_id: str, requestee_id: str
    ) -> FollowRequest:
    ...
    def accept_follow_request(
        ...
        return self.follower_repository.accept_follow_request(
    ...
    def decline_follow_request(
        ...
        return self.follower_repository.decline_follow_request(
            requester_id, requestee_id
        )
