...
class UserService:
    ...
    def post_user(self, data, user_id) -> User:
    ...
    def update_user(self, data, user_id) -> User:
    ...
    def get_similar_users(self, username_prefix, user_id) -> List[User]:
    ...
    def does_user_with_user_id_exist(self, user_id) -> bool:
